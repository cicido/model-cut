    ...
    with graph.as_default():
        ...
        for idx, module in enumerate(t7.modules):
            ...
            if module._typename == b'nn.SpatialReflectionPadding':
                ...
                if DEBUG:print('nn.SpatialUpSamplingNearest:',net)
                layers.append(net)
                ...
                if DEBUG:print('nn.SpatialMaxPooling:',net)
                layers.append(net)
            else:
